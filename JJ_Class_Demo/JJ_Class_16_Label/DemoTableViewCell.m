...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        NSDictionary *linkAttributes = [NSDictionary dictionaryWithObjectsAndKeys:@"#FF0000",@"color", nil];
        _rtLabel.linkAttributes = linkAttributes;
        NSDictionary *selectedLinkAttributes = [NSDictionary dictionaryWithObjectsAndKeys:@"#CCCCCC",@"color", nil];
        _rtLabel.selectedLinkAttributes = selectedLinkAttributes;
