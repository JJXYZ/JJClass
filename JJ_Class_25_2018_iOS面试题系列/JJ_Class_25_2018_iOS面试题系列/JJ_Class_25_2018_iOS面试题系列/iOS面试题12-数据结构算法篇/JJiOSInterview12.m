...
/**
 ...
 空的树（没有节点）可以理解为什么都没 像空气一样
 
 只有根节点。 （理解一个人只有一个头 其他的什么都没，说的有点恐怖）
 
 只有左子树 （一个头 一个左手 感觉越来越写不下去了）
 ...
 如果左子树非空，那么左子树所有节点的值均小于它的根节点
 
 如果右子树非空，那么右子树所有节点的值均大于它的根节点
 
 左右子树也分别为二叉排序树

 */
@implementation JJiOSInterview12
